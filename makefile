...
# Generated by qmake (2.01a) (Qt 4.8.4) on: ?? 5? 6 21:12:56 2014
# Project:  raymini.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) tmp/raymini1.0.0/ && $(COPY_FILE) --parents Window.h GLViewer.h QTUtils.h Vertex.h Triangle.h Mesh.h BoundingBox.h Material.h Object.h Light.h Scene.h RayTracer.h Ray.h KDTree.h tmp/raymini1.0.0/ && $(COPY_FILE) --parents Window.cpp GLViewer.cpp QTUtils.cpp Vertex.cpp Triangle.cpp Mesh.cpp BoundingBox.cpp Material.cpp Object.cpp Light.cpp Scene.cpp RayTracer.cpp Ray.cpp Main.cpp KDTree.cpp tmp/raymini1.0.0/ && (cd `dirname tmp/raymini1.0.0` && $(TAR) raymini1.0.0.tar raymini1.0.0 && $(COMPRESS) raymini1.0.0.tar) && $(MOVE) `dirname tmp/raymini1.0.0`/raymini1.0.0.tar.gz . && $(DEL_FILE) -r tmp/raymini1.0.0
