...
void Window::renderRayImage () {
	...
	/*
	rayTracer->traceOneRay(camPos, viewDirection, upVector, rightVector,
						   fieldOfView, aspectRatio,
						   289, 212,
						   screenWidth, screenHeight,
						   objects, interceptedTriangles, interceptedTrianglesPoints, interceptedTrianglesBarys, interceptedTrianglesDistance);
	
	for (unsigned int i = 0; i < interceptedTrianglesDistance.size(); i++) {
		cout << "<Triangle " << i+1 << ">" << endl
		<< "   Object: " << objects[i] << endl
		<< "   Points: " << interceptedTrianglesPoints[i] << endl
		<< "   Barys: " << interceptedTrianglesBarys[i] << endl
		<< "   Distance: " << interceptedTrianglesDistance[i] << endl
		<< endl;
	}
	*/
